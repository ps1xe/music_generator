...
const SoundPlayer = ({ id, name, genre, length, url, loaded }: SoundPlayerProps) => {
    ...
    //             <AudioPlayer  className="audio-player" style={{ marginBottom: "2%" }} src={url} controls />
    ...
    //                 onChange={handleSeek}
    //             />
    //             <div className="player-controls__time">{formatTime(currentTime)}</div>
    //         </div>
    //         <audio
    //             ref={audioRef}
    //             src={"https://s1.busic.net/files/mp3/pislya_doschu_-_hochesh_busic.net_128.mp3"}
